...
function politeInit() {
    ...
    devDynamicContent.SFID00478QFAirlineTourism_Tas_SpringRed_PlanetJul16_Sheet1[0].frame1_text_300x600 = "Uncover Tasmania's<br>breathtaking beauty";
    ...
    devDynamicContent.SFID00478QFAirlineTourism_Tas_SpringRed_PlanetJul16_Sheet1[0].frame2_text_300x600 = "And discover it's<br>colourful characters";
...
function initAnimation() {
    ...
    if (videoURL != "" && videoURL.indexOf('https://') > -1 && isDesktop) {
        ...
        startAnimation();
        adjustCopyLayout();
        TweenLite.set($("#red-shape-base"), {alpha:1})
    }
...
function startAnimation() {
    ...
    if (backup) {
        ...
        $("#f3-copy").hide()
        TweenLite.set($("#red-shape-end-frame2"), {rotation:50, scaleX: 2, scaleY: 2, x:230, y:130})
        // TweenLite.set($("#white-shape"), {scale:1, force3D:true, rotation:})

        tl.from(".button", 1.7, {alpha: 0, scaleX: .5, scaleY: .5, ease: Expo.easeOut}, "12.9")

        tl.to("#white-shape", 1.3, {alpha:1, rotation:-3, x:-80, y: 470, scaleX:1, scaleY:1, ease: Sine.easeInOut, force3D:false}, "11.7")
        tl.to(".logos-qantas", 1.3, {x:-4, y:-27, scaleX:.9, scaleY:.9, transformOrigin: "10% 50%", ease: Sine.easeInOut, force3D:false}, "11.7")
        tl.from(".logos-partners", 1, {alpha: 0, y:20, transformOrigin: "30% 50%", scaleX:.5, scaleY:.5, ease: Sine.easeOut}, "12.2")
        tl.from(".logo-divider", 1, {height:'1px', alpha:0, ease:Sine.easeOut}, "12.3")

        tl.from(".terms-wrapper", 1, {alpha: 0, ease: Sine.easeOut}, "12.9")


        tl.to("#red-shape-end-frame", 3, {autoAlpha:.5, scaleX: .6, scaleY: .6, x: -290, y: 10, rotation:-220, ease: Sine.easeOut}, "11.2")
        tl.to("#red-shape-end-frame2", 3, {autoAlpha:.4, rotation:100, scaleX: 1.4, scaleY: 1.4, x:20, y:160, ease: Sine.easeInOut}, "11.2")
